...
module.exports = async function bikinin(argv) {
    try {
        ...
        changeClientRoute(`./client/src/components/DashBoardContent.js`, argv.model, `./client/src/components/${ toPascalCase(argv.model)}.js`)
        editSidebarList(`./client/src/components/SidebarDashboard.js`, argv.model, `./client/src/components/${ toPascalCase(argv.model)}.js`)
        editDashboardHome(`./client/src/components/DashboardHome.js`, argv.model, `./client/src/components/${ toPascalCase(argv.model)}.js`)
