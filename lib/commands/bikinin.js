...
const { addNewModelController,
        addRouting,
        addRoutingIndex,
        addModel } = require('../functions/regex/server')
...
module.exports = async function bikinin(argv) {
    try {
        ...
        // editSidebarList(`./client/src/components/SidebarDashboard.js`, 'Product')
        ...
        addRoutingIndex('./server/routes/index.js','modelnametest')
        addRouting(`../../resources/server/example-route.js`, `./server/routes/${argv.model.toLowerCase()}.js`, argv.model.toLowerCase())
        addNewModelController(`../../resources/server/example-controller.js`, `./server/controllers/${argv.model.toLowerCase()}.js`, argv.model.toLowerCase())
        addModel(`../../resources/server/example-schema.js`, `./server/models/${argv.model.toLowerCase()}.js`, argv.model.toLowerCase())
